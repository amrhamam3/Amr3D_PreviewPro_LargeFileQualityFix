...
class DXF2DView @JvmOverloads constructor(
    ...
    private fun drawMeasureLine(canvas: Canvas, sx1: Float, sy1: Float, sx2: Float, sy2: Float, distMm: Float, drawDeleteButton: Boolean): FloatArray {
